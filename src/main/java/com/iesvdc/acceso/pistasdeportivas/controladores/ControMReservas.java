...
public class ControMReservas {
    ...
    public String listarReservas(Model model) {
        ...
        List<Reserva> reservas = repoReserva.findByUsuario(loggedUser);
    ...
    public String crearReserva(@ModelAttribute Reserva reserva, Model model) {
        ...
        boolean reservaExistente = repoReserva.existsByUsuarioAndFecha(usuario, reserva.getFecha());
        if(reservaExistente){
...
public String editarReserva(@PathVariable Long id, @ModelAttribute Reserva reserva, Model model) {
    ...
    Usuario usuario = getLoggedUser();
        ...
        Reserva reservaExiste = repoReserva.findById(id).orElse(null);
    ...
    repoReserva.save(reservaExiste);
    return "redirect:/mis-datos/mis-reservas";
